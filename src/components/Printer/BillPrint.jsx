  ...
  return (
    <div className="print-area">
      <Card className="min-w-[280px] w-fit !bg-transparent border !rounded-none border-black !shadow-none">
        <CardHeader className="text-center space-y-2 p-0 border-zinc-400 border-b">
          <div className="space-y-1">
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight">
              Jeddah Traders
            </h1>
            <h2 className="text-xl !mt-0 font-bold tracking-tight">
              And Corporations
            </h2>
          </div>
          <div>
            ...
            <h4 className="mb-3 tracking-tight font-semibold">
              +92 316 8558212
            </h4>
          </div>
        </CardHeader>
          ...
          <div className="px-6 py-4">
                ...
                <TableBody>
                  <TableRow className="bg-gray-50 border-b border-gray-400">
                    {singleUser?.items?.length >= 1 ? (
                      <TableHead className="font-semibold !h-[31px] border-r border-gray-400">
                        Bill No:
                      </TableHead>
                    ) : (
                      <TableHead className="font-semibold border-r !h-[31px] border-gray-400">
                        Recipt Id:
                      </TableHead>
                    )}
                  ...
                  <TableRow className="border-b border-gray-400 !h-[31px]">
                    <TableHead className="font-semibold !h-[31px] border-r border-gray-400">
                      Customer:
                    </TableHead>
                    <TableCell className="font-medium !h-[31px] border-gray-400">
                      <span>{singleUser?.customer?.fullname}</span>
                    </TableCell>
                  </TableRow>
                  <TableRow className="border-b !h-[31px] border-gray-400">
                    <TableHead className="font-semibold !h-[31px] border-r border-gray-400">
                      Customer ID:
                    </TableHead>
                    <TableCell className="font-medium !h-[31px] border-gray-400">
                  ...
                  <TableRow className="border-b !h-[31px] border-gray-400">
                    ...
                    <TableCell className="border-gray-400 !h-[31px]">
            ...
            {singleUser?.items?.length >= 1 ? (
              <div className="border border-gray-200 overflow-hidden">
                <Table className="border border-gray-400 text-center">
                  <TableHeader>
                    <TableRow className="bg-gray-50 border-b border-gray-400">
                      <TableHead className="w-16 text-center !h-[31px] font-semibold border-r border-gray-400">
                        Sr.
                      </TableHead>
                      <TableHead className="font-semibold border-r !h-[31px] border-gray-400">
                        Product
                      </TableHead>
                      <TableHead className="w-24 text-center !h-[31px] font-semibold border-r border-gray-400">
                        Qty
                      </TableHead>
                      <TableHead className="w-32 text-center !h-[31px] font-semibold border-gray-400">
                        Amount
                      </TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {singleUser.items.map((item, index) => {
                      return (
                        ...
                        >
                          <TableCell className="text-blue-600 !h-[31px] font-medium border-r border-gray-400">
                            {index + 1}
                          </TableCell>
                          <TableCell className="font-medium border-r !h-[31px] border-gray-400">
                            {item?.name}
                          </TableCell>
                          <TableCell className="text-center border-r !h-[31px] border-gray-400">
                            {item?.qty}
                          </TableCell>
                          <TableCell className="text-center font-medium !h-[31px] border-gray-400">
                            {item?.amount}
                          </TableCell>
                        </TableRow>
                      );
            ...
            <div className="mt-2">
              <Table className="border border-gray-400">
                <TableBody>
                  {singleUser?.items?.length >= 1 ? (
                    <TableRow className="bg-gray-50 border-b !h-[31px] border-gray-400">
                      <TableHead className="font-semibold border-r !h-[31px] border-gray-400">
                        Total
                      </TableHead>
                      <TableCell className="font-bold !h-[31px] border-gray-400">
                        {singleUser?.amount}
                      </TableCell>
                    </TableRow>
                  ) : null}
                  ...
                  <TableRow className="border-b border-gray-400">
                    ...
                    <TableCell className="font-bold !py-0 border-gray-400">
                  ...
                  <TableRow className="border-b border-gray-400">
                    {singleUser?.items?.length >= 1 ? (
                      ...
                      <>
                        ...
                        <TableCell className="border-gray-400 !py-0 font-bold">
            ...
            <div className="text-center text-sm">www.jeddahtraders.com</div>
          </div>
        </CardContent>
